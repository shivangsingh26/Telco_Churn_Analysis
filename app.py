...
#WE USE GET METHOD TO RETRIEVE DATA FROM THE SERVER
#WE USE POST METHOD WHEN SUBMITTING SENSITIVE DATA TO THE SERVER
...
def predict():
    ...
    #WE HAVE 19 INPUTS THAT IS 19 DIFFERENT FEATURE VALUES
    #USING ONE HOT ENCOIDNG WE OBTAIN A TOTAL OF 50-51 FEATURES
